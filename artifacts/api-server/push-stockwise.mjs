#!/usr/bin/env node
// Create stockwise-go repo on GitHub and push initial Go project structure
...
const REPO  = "stockwise-go";
const SRC   = "/tmp/stockwise-go";
...
if (repoCheck.status === 404) {
  const r = await gh("POST", `/user/repos`, {
    name: REPO,
    description: "Sistema de controle de estoque — Go · React · PostgreSQL · JWT",
    private: false,
    auto_init: false,
    has_issues: true,
    topics: ["go", "golang", "react", "postgresql", "jwt", "rest-api"],
  });
