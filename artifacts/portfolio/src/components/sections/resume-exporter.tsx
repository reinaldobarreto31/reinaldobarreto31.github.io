...
import {
  SiRuby, SiRubyonrails, SiPostgresql, SiDocker, SiGithubactions,
  SiReact, SiJava, SiSpringboot, SiVuedotjs, SiAngular, SiGo, SiSwagger,
  SiTypescript,
} from "react-icons/si";
import {
  CONTACT,
...
function SkillBarStatic({ name, level, color }: { name: string; level: number; color: string }) {
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between text-[11px] font-mono">
        <span className="text-foreground font-semibold">{name}</span>
        <span style={{ color: color || "#cc0000", fontWeight: 700 }}>{level}%</span>
      </div>
      <div className="h-[6px] w-full rounded-full bg-[#282a36] overflow-hidden border border-[#44475a]/70">
        <div
    ...
    >
      ...
      >
        ...
        >
          <div style={{ marginBottom: 40 }}>
            <div
              style={{
                ...
                background: "linear-gradient(135deg,#a0172a,#cc0000,#e33446)",
                padding: 4, display: "grid", placeItems: "center",
                boxShadow: "0 12px 28px rgba(204,0,0,.35)",
                marginBottom: 18,
              }}
            >
              <div style={{ width: 104, height: 104, borderRadius: 999, overflow: "hidden", background: "#282a36" }}>
                <img
                  src="/foto-reinaldo.png"
                  alt="Reinaldo"
            ...
            >
              Reinaldo <span style={{ color: "#ff6e6e" }}>Barreto</span>
            </h1>
            ...
            <p style={{
              ...
              color: "#6272a4", marginTop: 10, marginBottom: 0,
              lineHeight: 1.5,
            }}>
              APIs RESTful · TDD · OpenAPI 3 · PostgreSQL · Docker
            </p>
          </div>

          <section style={{ marginBottom: 36 }}>
            <h3 style={h3Style("#cc0000")}>Contato</h3>
          ...
          <section style={{ marginBottom: 36 }}>
            <h3 style={h3Style("#cc0000")}>Habilidades Técnicas</h3>
              ...
              {EDUCATION.map((e) => (
                <div key={e.course} style={{ display: "flex", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, fontFamily: "ui-monospace, monospace", margin: "3px 0 0", color: "#ff6e6e" }}>
                      {e.period}
                    </p>
                  </div>
                </div>
        ...
        <main
          style={{
            ...
            boxSizing: "border-box",
            background:
              "linear-gradient(180deg, rgba(40,42,54,.7) 0%, rgba(68,71,90,.35) 100%)",
          }}
        >
          <div
            style={{
          ...
          >
            <div>
              <h1 style={{
                ...
                margin: 0, color: "#f8f8f2", lineHeight: 1.1,
              }}>
            ...
            <div style={{ textAlign: "right", fontSize: 12.5, color: "#f8f8f2", display: "flex", flexDirection: "column", gap: 7 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8 }}>
                <Phone size={13} style={{ color: "#ff6e6e" }} />
                <span style={{ fontFamily: "ui-monospace, monospace" }}>55 47 98830 2308</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8 }}>
                <Mail size={13} style={{ color: "#ff6e6e" }} />
                <span>reinaldobarretosilva@gmail.com</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, color: "#bd93f9" }}>
                <Sparkles size={13} />
                <span>linkedin.com/in/reinaldo-barreto-2a4ba2116</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, color: "#8be9fd" }}>
                <Sparkles size={13} />
                <span>github.com/reinaldobarreto31</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8 }}>
                <MapPin size={13} style={{ color: "#50fa7b" }} />
          ...
          <section style={{ marginBottom: 30 }}>
            <h3 style={h3Col2Style("#cc0000")}>Resumo Profissional</h3>
            <p style={pStyle}>
              Engenheiro de Software com trajetória sólida em <strong style={{ color: "#cc0000" }}>Ruby on Rails</strong>{" "}
              e background enterprise em <strong style={{ color: "#cc0000" }}>Java/Spring Boot</strong>. Especialista em{" "}
              <strong style={{ color: "#f8f8f2" }}>APIs RESTful</strong> para o setor público (estadual, municipal) e
              segurança pública. Domínio de <strong style={{ color: "#f8f8f2" }}>TDD com RSpec</strong>, documentação
              automática via <strong style={{ color: "#cc0000" }}>Rswag/OpenAPI 3</strong> e entrega com{" "}
              <strong style={{ color: "#cc0000" }}>CI/CD (GitHub Actions)</strong>.{" "}
              <em style={{ color: "#bd93f9" }}>Convention over Configuration</em> como filosofia de trabalho.
            </p>
          </section>

          <section style={{ marginBottom: 30 }}>
            <h3 style={h3Col2Style("#bd93f9")}>Objetivo Profissional</h3>
            <div
              style={{
                padding: "14px 18px",
                borderRadius: 10,
                border: "1px solid rgba(241,250,140,.45)",
                background: "linear-gradient(135deg, rgba(241,250,140,.1), rgba(40,42,54,.92))",
                marginTop: 14,
              }}
            >
              <p style={{ ...pStyle, margin: 0, color: "#f8f8f2" }}>
                Atuar como <strong style={{ color: "#ffb86c" }}>Engenheiro de Software Ruby on Rails</strong>{" "}
                em produto de alto impacto — contribuindo com arquitetura de APIs RESTful, TDD rigoroso, documentação
                OpenAPI 3 e entrega contínua em produção.
              </p>
            </div>
          </section>

          <section style={{ marginBottom: 32 }}>
            <h3 style={h3Col2Style("#cc0000")}>Experiência Profissional</h3>
              ...
              {EXPERIENCES.map((exp) => (
                <article
                  ...
                  style={{
                    ...
                    boxShadow: "0 10px 26px rgba(0,0,0,.3), inset 0 1px rgba(255,255,255,.04)",
                  }}
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
                    <div>
                      <h4 style={{ fontSize: 15, fontWeight: 700, margin: 0, color: "#f1fa8c" }}>
                        {exp.company}
                      </h4>
                      <h5 style={{ fontSize: 13, fontWeight: 700, color: "#ff6e6e", margin: "6px 0 0" }}>
                        {exp.role}
                      </h5>
                    </div>
                    <div style={{ textAlign: "right", fontSize: 11.5, fontFamily: "ui-monospace, monospace", color: "#6272a4", display: "flex", flexDirection: "column", gap: 5 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, justifyContent: "flex-end" }}>
                        <CalendarDays size={12} style={{ color: "#ff6e6e" }} />
          ...
          <section>
            <h3 style={h3Col2Style("#f1fa8c")}>Projetos Pessoais</h3>
              ...
              {PERSONAL_PROJECTS.map((p) => (
                <article
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(98,114,164,.55)",
                    background:
                      "linear-gradient(145deg, rgba(68,71,90,.8), rgba(40,42,54,.92))",
                    borderLeft:
                      p.badge === "LIVE"
                        ? "3px solid #50fa7b"
                        : p.badge === "DESTAQUE"
                        ...
                        ? "3px solid #bd93f9"
                        : "3px solid #ffb86c",
                    boxShadow: "0 10px 24px rgba(0,0,0,.28), inset 0 1px rgba(255,255,255,.035)",
                    position: "relative",
                  }}
                >
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                    <div>
                      <h4 style={{ fontSize: 14, fontWeight: 800, margin: 0, color: "#f8f8f2" }}>
                        {p.title.split("—")[0]}
                        {p.title.includes("—") && (
                          <span style={{ color: "#6272a4", fontWeight: 500 }}> — {p.title.split("—")[1]}</span>
                        )}
                      </h4>
                      <p style={{
                        fontSize: 11.5, fontFamily: "ui-monospace, monospace",
                        color: "#ffb86c", marginTop: 5, marginBottom: 0,
                      }}>
                        {p.stack}
                      </p>
                    </div>
          ...
          <div style={{
            marginTop: 36, paddingTop: 16, borderTop: "1px solid rgba(98,114,164,.5)",
            display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10,
            fontSize: 10.5, fontFamily: "ui-monospace, monospace", color: "#6272a4",
          }}>
            <div>
              <span style={{ color: "#ff6e6e", fontWeight: 700 }}>♥</span> Ruby on Rails · TDD · OpenAPI 3 · CI/CD
            </div>
            <div>
              Stack image export: <span style={{ color: "#50fa7b" }}>pdf-lib</span> ·{" "}
              <span style={{ color: "#bd93f9" }}>pdf.js</span> ·{" "}
              <span style={{ color: "#ff6e6e" }}>html2canvas</span> ·{" "}
              <span style={{ color: "#cc0000" }}>Tema Dracula + Rails #cc0000</span>
            </div>
          </div>
        </main>
      </div>
